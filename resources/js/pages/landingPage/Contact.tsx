...
import { Mail, MapPin, Phone, Instagram, Linkedin, Youtube, Globe, MessageCircle } from "lucide-react";
...
export default function ContactPage() {
  const { settings, branding, companyAddress, companyContacts, companySocials, flash } = usePage<SettingsProps & { flash?: { success?: string } }>().props;
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      {companySocials.instagram && (
                        <a href={companySocials.instagram} target="_blank" rel="noopener noreferrer" className="rounded-full bg-pink-50 p-2 text-pink-600 transition-colors hover:bg-pink-100 dark:bg-pink-900/20 dark:text-pink-400 dark:hover:bg-pink-900/40">
                          <Instagram className="h-5 w-5" />
                        </a>
                      )}
                      {companySocials.linkedin && (
                        <a href={companySocials.linkedin} target="_blank" rel="noopener noreferrer" className="rounded-full bg-blue-50 p-2 text-blue-700 transition-colors hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/40">
                          <Linkedin className="h-5 w-5" />
                        </a>
                      )}
                      {companySocials.youtube && (
                        <a href={companySocials.youtube} target="_blank" rel="noopener noreferrer" className="rounded-full bg-red-50 p-2 text-red-600 transition-colors hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40">
                          <Youtube className="h-5 w-5" />
                        </a>
                      )}
                      {companySocials.website && (
                        <a href={companySocials.website} target="_blank" rel="noopener noreferrer" className="rounded-full bg-slate-50 p-2 text-slate-600 transition-colors hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700">
