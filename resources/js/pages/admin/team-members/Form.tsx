                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="role" value={data.role} onChange={(event) => setData('role', event.target.value)} required />
                            ...
                            <div className="grid gap-2 md:grid-cols-2">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="linkedin" value={data.linkedin ?? ''} onChange={(event) => setData('linkedin', event.target.value)} />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Textarea id="bio" value={data.bio ?? ''} onChange={(event) => setData('bio', event.target.value)} />
